...
async def RaspaManager(e):
	...
	if e.is_private and e.chat_id == ADMIN:
		if e.text == "/start":
			...
			await e.respond("**🎛 Pannello di Controllo 🎛\n\n⚙ Versione » 1.0\n\n👨🏼‍💻 Developer » @disinstallato**", buttons=[[Button.inline("🙈 Sessioni 🙈", "voip"), Button.inline("🌐 Proxy 🌐", "proxy")], [Button.inline("💣 Ruba 💣", "grab"), Button.inline("➕ Adder ➕", "add")], [Button.url("☎️ Assistenza ☎️", "https://t.me/Disinstallato")]])
		elif Getter != None:
			if Getter == 0:
				Getter = None
...
async def callbackQuery(e):
	...
	if e.sender_id == ADMIN:
		if e.data == b"back":
			Getter, Number, TempClient = None, None, None
			await e.edit("**🎛 Pannello di Controllo 🎛\n\n⚙ Versione » 1.0\n\n👨🏼‍💻 Developer » @disinstallato**", buttons=[[Button.inline("🙈 Sessioni 🙈", "voip"), Button.inline("🌐 Proxy 🌐", "proxy")], [Button.inline("💣 Ruba 💣", "grab"), Button.inline("➕ Adder ➕", "add")], [Button.url("☎️ Assistenza ☎️", "https://t.me/Disinstallato")]])
		elif e.data == b"stop":
